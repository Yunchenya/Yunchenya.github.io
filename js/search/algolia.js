window.addEventListener("load", () => {
  ...
  const search = instantsearch({
    ...
    searchFunction(helper) {
      if (helper.state.query) {
        let innerLoading = '<i class="beatricefont beatrice-icon-spinner anzhiyu-spin"></i>';
  ...
  const pagination = instantsearch.widgets.pagination({
    ...
    templates: {
      first: '<i class="beatricefont beatrice-icon-angle-double-left"></i>',
      last: '<i class="beatricefont beatrice-icon-angle-double-right"></i>',
      previous: '<i class="beatricefont beatrice-icon-angle-left"></i>',
      next: '<i class="beatricefont beatrice-icon-angle-right"></i>',
    },
    scrollTo: false,
    showFirstLast: false,
    cssClasses: {
