(function () {
  ...
  const aiTitleRefreshIcon = post_ai.querySelector(".ai-title .beatricefont.beatrice-icon-arrow-rotate-right");
  let aiReadAloudIcon = post_ai.querySelector(".beatrice-icon-circle-dot");
  ...
  async function readAloud() {
    ...
    aiReadAloudIcon = post_ai.querySelector(".beatrice-icon-circle-dot");
